...
<head>
    ...
    <title>Felix's RotiBakar</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow" style="background-color:limegreen">
        <div class="container ">
            <a class="navbar-brand text-white" href="index.php"><b>Felix's Roti Bakar</b></a>
                    ...
                    <form action="" method="post">
                        <div class="p-4">
                            <div class="input-group mb-3">
                                <span class="input-group-text " style="background-color:limegreen">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text" style="background-color:limegreen"><i
