...
<head>
    ...
    <title>Felix Roti Bakar</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow">
        <div class="container ">
            <a class="navbar-brand " style="color: limegreen;" href="#"><b>Felix's Roti Bakar</b></a>
                    ...
                    <div class="item pb-4 my-5" style="height: 450px;">
                        <div class="text-center pt-0 mt-0 pb-4 mb-3" style="border-radius: 15px;">
                            <div class="card  text-white shadow pt-0 mt-0 h-auto mb-3"
                                style="width: 18rem; border-radius: 15px; background-color:limegreen;">
